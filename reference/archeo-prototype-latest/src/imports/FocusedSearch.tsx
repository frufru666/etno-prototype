import svgPaths from "./svg-j9tz1tk2uo";
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
      ...
      <div className="bg-[#fafafa] flex-[1_0_0] h-[40px] min-h-px min-w-px relative rounded-[8px]" data-name="Input">
...
export default function FocusedSearch() {
  return (
    <div className="bg-white overflow-clip relative rounded-[24px] size-full" data-name="Focused search">
      <HeaderArcheo />
