import svgPaths from "./svg-1xpz95zc86";
        ...
        <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icon">
          <div className="absolute inset-[9.38%_9.38%_9.37%_9.37%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.5 19.5">
              <path d={svgPaths.p2dc6cf00} fill="var(--fill-0, #171717)" id="Vector" />
            </svg>
          </div>
        </div>
        <Container1 />
...
function ListItem() {
  return (
    <div className="content-stretch cursor-pointer flex flex-[1_0_0] flex-col h-[578px] items-start min-h-px min-w-px relative" data-name="List Item">
      <button className="content-stretch flex items-start relative shrink-0 w-full" data-name="List Radio">
...
function ListContainer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center left-[8px] overflow-x-clip overflow-y-auto px-[3px] top-[179px] w-[377px]" data-name="List Container">
      <ListItem />
    </div>
  );
}
...
export default function Radio() {
  return (
    <div className="bg-white overflow-clip relative rounded-[16px] size-full" data-name="Radio">
