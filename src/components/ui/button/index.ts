  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        nav:
          "bg-card text-primary-600 hover:bg-primary-50 active:bg-primary-100 focus-visible:ring-2 focus-visible:ring-primary-500",
        // Active nav item: 2px primary outline, blue text
        navActive:
          "border-2 border-primary-500 bg-transparent text-primary-600 hover:bg-primary-50 active:bg-primary-100 focus-visible:ring-2 focus-visible:ring-primary-500",
        secondary:
          "border border-primary-500 bg-card text-primary-600 hover:bg-primary-50 active:bg-primary-100 focus-visible:ring-2 focus-visible:ring-primary-500",
        outline:
          "border border-primary-500 bg-card text-primary-600 hover:bg-primary-50 active:bg-primary-100 focus-visible:ring-2 focus-visible:ring-primary-500",
        outlined:
          "border border-primary-500 bg-card text-primary-600 hover:bg-primary-50 active:bg-primary-100 focus-visible:ring-2 focus-visible:ring-primary-500",
        toggle:
          "bg-card text-primary-600 hover:bg-primary-100 active:bg-primary-200 focus-visible:ring-2 focus-visible:ring-primary-500",
        ghost:
        ...
        destructive:
          "bg-error text-white hover:bg-error/80 active:bg-error/90 focus-visible:ring-2 focus-visible:ring-error",
        danger:
          "bg-error text-white hover:bg-error/80 active:bg-error/90 focus-visible:ring-2 focus-visible:ring-error",
        dangerSecondary:
